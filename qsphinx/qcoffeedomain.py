...
# QModule inherits from Directive to allow it to output titles etc.
...
class QClass(QObj):
    ...
    def handle_signature(self, sig, signode):
        fullname = super(QClass, self).handle_signature(sig, signode)
...
class QXRefRole(XRefRole):
    def process_link(self, env, refnode, has_explicit_title, title, target):
        """ Called after QDomain.resolve_xref """
